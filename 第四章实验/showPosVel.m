...
plot(x, X, 'b', 'LineWidth', 0.75);grid on;hold on;
...
plot(x, Y, 'b', 'LineWidth', 0.75);grid on;hold on;
plot(x, pidY, 'r--', 'LineWidth', 0.75);grid on;hold on;
axis([0 10 -0.02 0.02]);
...
plot(x, Z, 'b', 'LineWidth', 0.75);grid on;hold on;
...
% fimename = 'D:\Flycontrol\SCUT_thesis\Fig\INDI位置控制定点悬停抗风实验仿真结果.pdf';
...
% plot(x, V_n(:, 1), 'b', 'LineWidth', 0.75);grid on;hold on;
...
% plot(x, V_n(:, 2), 'b', 'LineWidth', 0.75);grid on;hold on;
...
% plot(x, V_n(:, 3), 'b', 'LineWidth', 0.75);grid on;hold on;
