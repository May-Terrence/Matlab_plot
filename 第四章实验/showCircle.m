...
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\圆弧轨迹飞行实验位置跟踪结果.pdf';
...
% fimename = 'D:\Flycontrol\SCUT_thesis\Fig\圆弧轨迹飞行实验二维平面轨迹结果.pdf';
...
fig.Units = 'centimeters';
fig.Position = [0 0 15 8.8]; 
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\圆弧轨迹飞行实验速度跟踪结果.pdf';
...
fig.Units = 'centimeters';
fig.Position = [0 0 15 8.8]; 
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\圆弧轨迹飞行实验姿态跟踪结果.pdf';
